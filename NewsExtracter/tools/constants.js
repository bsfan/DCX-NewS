var _root_feed = '/Users/ntop/Documents/nodespace/Nodejs/rss/feed/';
var _root_top = '/Users/ntop/Documents/nodespace/Nodejs/rss/top/';
var _root_article = '/Users/ntop/Documents/nodespace/Nodejs/rss/article/';
...
exports.makeArticlePath = function(filename){
    return (_root_article+filename+'.html');
}

exports.makeFeedPath = function(filename){
    return (_root_feed+filename+'.json');
}

exports.makeTopPath = function(filename){
    return (_root_top+filename+'.json');
}
