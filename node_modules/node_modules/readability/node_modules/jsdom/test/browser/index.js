var dom = require("../../lib/jsdom/level2/core.js").dom.level2.core;
var browser = require("../../lib/jsdom/browser/index.js").browserAugmentation(dom);
...
exports.tests = {
  ...
  serialize_styleattribute: function(test) {
    var doc = new browser.Document();
    var domToHtml = require('../../lib/jsdom/browser/domtohtml.js');
