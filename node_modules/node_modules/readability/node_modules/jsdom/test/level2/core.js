...
exports['attrgetownerelement'] = testcase({
  setUp: function(cb){
    this.doc = require('core/files/staffNS.xml.js').staffNS();
    cb();
  },
  ...
  attrgetownerelement04: function(test) {
    var docImport = require('core/files/staff.xml.js').staff();
...
exports['createAttributeNS'] = testcase({
  ...
  createAttributeNS01: function(test) {
    ...
    var doc = require('core/files/staffNS.xml.js').staffNS();
  ...
  createAttributeNS06: function(test) {
    ...
    var doc = require('core/files/hc_staff.xml.js').hc_staff();
...
exports['createDocument'] = testcase({
  ...
  createDocument04: function(test) {
    ...
    var domImpl;
    var doc = require('core/files/staffNS.xml.js').staffNS();
    var aNewDoc = require('core/files/staffNS.xml.js').staffNS();
    docType = doc.doctype;
...
exports['createDocumentType'] = testcase({
  ...
  createDocumentType04: function(test) {
    ...
    var qualifiedName;
    var docType = null;
    var domImpl = require('core/files/staffNS.xml.js').staffNS().implementation;
...
exports['documentimportnode'] = testcase({
  ...
  documentimportnode02: function(test) {
    ...
    var doc = require('core/files/staffNS.xml.js').staffNS();
    var docImported = require('core/files/staff.xml.js').staff();
  ...
  documentimportnode15: function(test) {
    ...
    var doc = require('core/files/staffNS.xml.js').staffNS();
    var docImp = require('core/files/staffNS.xml.js').staffNS();
...
exports['domimplementationfeaturecore'] = testcase({
  ...
  domimplementationfeaturecore: function(test) {
    ...
    var doc = require('core/files/staff.xml.js').staff();
    domImpl = doc.implementation;
...
exports['elementsetattributenodens'] = testcase({
  ...
  elementsetattributenodens05: function(test) {
    ...
    var doc = require('core/files/staffNS.xml.js').staffNS();
    var docAlt = require('core/files/staffNS.xml.js').staffNS();
...
exports['importNode'] = testcase({
  ...
  importNode04: function(test) {
    ...
    var childValue;
    var doc = require('core/files/staff.xml.js').staff();
    var aNewDoc = require('core/files/staff.xml.js').staff();
  ...
  importNode16: function(test) {
    ...
    var doc = require('core/files/staffNS.xml.js').staffNS();
    var anotherDoc = require('core/files/staffNS.xml.js').staffNS();
...
exports['internalSubset'] = testcase({
  ...
  internalSubset01: function(test) {
    ...
    var doc = require('core/files/staff2.xml.js').staff2();
    docType = doc.doctype;
...
exports['setAttributeNodeNS'] = testcase({
  ...
  setAttributeNodeNS05: function(test) {
    var doc1 = require('core/files/staffNS.xml.js').staffNS();
    var doc2 = require('core/files/staffNS.xml.js').staffNS();
    var success;
    var namespaceURI = "http://www.newattr.com";
    var qualifiedName = "emp:newAttr";
    var newAttr;
