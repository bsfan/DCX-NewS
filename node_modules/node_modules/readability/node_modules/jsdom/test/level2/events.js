...
var events = require("../../lib/jsdom/level2/events.js").dom.level2.events;
...
var _setUp = function() {
  var doc = require('events/files/hc_staff.xml.js').hc_staff();
...
exports['dispatch event'] = testcase({
  setUp: function(cb){
    this.doc = require('events/files/hc_staff.xml.js').hc_staff();
    cb();
  },
