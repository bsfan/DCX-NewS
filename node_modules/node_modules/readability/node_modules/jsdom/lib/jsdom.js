...
var dom      = exports.dom = require("jsdom/level3/index.js").dom,
    features = require('jsdom/browser/documentfeatures.js'),
    fs       = require("fs"),
    pkg      = JSON.parse(fs.readFileSync(__dirname + "/../package.json")),
    request  = require('request'),
    URL      = require('url');

var style = require('jsdom/level2/style.js');
exports.defaultLevel = dom.level3.html;
exports.browserAugmentation = require("jsdom/browser/index.js").browserAugmentation;
exports.windowAugmentation = require("jsdom/browser/index.js").windowAugmentation;
...
var createWindow = exports.createWindow = require("jsdom/browser/index.js").createWindow;
...
exports.jsdom = function (html, level, options) {
  ...
  if (options.features && options.features.QuerySelector) {
    require("jsdom/selectors/index.js").applyQuerySelectorPrototype(level);
  }
