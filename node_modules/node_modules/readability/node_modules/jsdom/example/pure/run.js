var browser = require("../../lib/jsdom/browser/index.js");
var dom = new browser.browserAugmentation(require("../../lib/jsdom/level2/html.js").dom.level2.html);
...
window.Sizzle = require("../sizzle/sizzle.js").sizzleInit(window, doc);
var $   = require("pure.js").pureInit(window, doc);
