...
timed(function(){
        ...
        /**
         * So we have all of the content that we need. Now we clean it up for presentation. ntop.change..
        **/
        readability.prepArticle(articleContent);

        if (readability.curPageNum === 1) {
            articleContent.innerHTML = '<div id="readability-page-1">' + articleContent.innerHTML + '</div>';
        }
...
var MyProfiler = {
	...
	timed: function(func, name, options) {
		...
		st.count++;
		if (!options.silent)
			util.log(new Array(z.timed_level).join('  ') + ellapsed / 1000 + ' seconds [' + name + '] ' + (options.moreInfo || ''));
		z.timed_level--;
		return ret;
	},
